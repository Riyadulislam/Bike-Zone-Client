...
const Aboutus = () => {
    return (
        <div className='mt-5'>
            <h1 className='text-center font-bold text-3xl'>Our Goal</h1>
            <p className='w-1/2 mx-auto text-xl'>BikeZone.com has a straightforward goal to simplify the sales process of
                 ...
                 motorcycles, dirt bikes, ATVs, side-by-sides, quads, and trailers.
                  Ove the years we’ve gained the knowledge and expertise it takes to
                   ...
                   and with over 200 locations nationwide, dropping off the vehicle or
                    getting it picked up by one of our dedicated drivers, makes the 
                    process quick and convenient</p>
        </div> 
    );
};
